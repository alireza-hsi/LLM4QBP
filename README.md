...
- **Need step-by-step installation or troubleshooting?**
  See [INSTALL.md](./INSTALL.md) for detailed instructions on setting up Conda environments, Node.js, and more.
